...
Нажаль наш алгоритм працює не для всіх графів, наприклад в папці graphs є файл 20v.txt, якщо бути точним,то не алгоритм не працює на великих графах, через те що хороший алгоритм перевірки на планарність без networkx дуже важко)
