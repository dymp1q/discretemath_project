...
Розподіл роботи:
Інтерфейс, візуалізація  -> Сю Олексій
Читання графу і записування результату -> Якимчук Галина
Алгоритм -> Дмитрів Мар'ян
Перевірки на планарність -> Шимчук Соломія
Додаткові функції для алгоритму -> Німас Ксенія
